  ...
  <div class="row">
      ...
      <div class="card">
        <div class="card-content">
          ...
          <img
            ...
            src="{{ asset('themes/assets/compiled/jpg/banana.jpg') }}"
            alt="Card image cap"
          />
        </div>
    ...
    <div class="col-xl-4 col-md-6 col-sm-12">
      <div class="card">
        <div class="card-content">
          <img
            src="{{ asset('themes/assets/compiled/jpg/motorcycle.jpg') }}"
          ...
          >
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img
                  src="{{ asset('themes/assets/compiled/jpg/architecture1.jpg') }}"
                  class="d-block w-100"
              ...
              <div class="carousel-item">
                <img
                  src="{{ asset('themes/assets/compiled/jpg/bg-mountain.jpg') }}"
                  class="d-block w-100"
                  alt="Image Mountain"
                />
              </div>
              <div class="carousel-item">
                <img
                  src="{{ asset('themes/assets/compiled/jpg/jump.jpg') }}"
                  class="d-block w-100"
                  alt="Image Jump"
                />
              </div>
      ...
      <div class="card">
        <div class="card-content">
          <img
            ...
            src="{{ asset('themes/assets/compiled/jpg/building.jpg') }}"
            alt="Card image cap"
    ...
    <div class="col-md-6 col-sm-12">
      <div class="card">
        <div class="card-content">
          <img
            class="card-img-top img-fluid"
            src="{{ asset('themes/assets/compiled/jpg/origami.jpg') }}"
            alt="Card image cap"
            style="height: 20rem"
          />
          <div class="card-body">
    ...
    <div class="col-md-6 col-sm-12">
      <div class="card">
        <div class="card-content">
          ...
          <img
            class="card-img-bottom img-fluid"
            src="{{ asset('themes/assets/compiled/jpg/water.jpg') }}"
            alt="Card image cap"
            style="height: 20rem; object-fit: cover"
          />
        </div>
      ...
      <div class="card-group">
        <div class="card">
          <div class="card-content">
            <img
              class="card-img-top img-fluid"
              src="{{ asset('themes/assets/compiled/png/1.png') }}"
              alt="Card image cap"
            />
            <div class="card-body">
        ...
        <div class="card">
          <div class="card-content">
            <img
              class="card-img-top img-fluid"
              src="{{ asset('themes/assets/compiled/png/2.png') }}"
              alt="Card image cap"
            />
            <div class="card-body">
              <h4 class="card-title">Card title</h4>
        ...
        <div class="card">
          <div class="card-content">
            <img
              class="card-img-top img-fluid"
              src="{{ asset('themes/assets/compiled/png/3.png') }}"
              alt="Card image cap"
            />
            <div class="card-body">
              <h4 class="card-title">Card title</h4>
        ...
        <div class="card">
          <div class="card-content">
            <img
              class="card-img-top img-fluid"
              src="{{ asset('themes/assets/compiled/png/4.png') }}"
              alt="Card image cap"
            />
            <div class="card-body">
              <h4 class="card-title">Card title</h4>
