        ...
        <div class="row">
            <div class="col-12 col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <x-maz-alert type="primary">
                            This is primary alert.
                        </x-maz-alert>
                        <x-maz-alert type="success">
                            This is success alert.
                        </x-maz-alert>
                        <x-maz-alert type="warning">
                            This is warning alert.
                        </x-maz-alert>
                        <x-maz-alert type="danger">
                            This is danger alert.
                        </x-maz-alert>
                        <x-maz-alert type="dark">
                            This is dark alert.
                        </x-maz-alert>
                        <x-maz-alert type="secondary">
                            This is secondary alert.
                        </x-maz-alert>
                        <x-maz-alert type="light">
                            This is light alert.
                        </x-maz-alert>
                        <x-maz-alert type="info">
                            This is info alert.
                        </x-maz-alert>
                    </div>
                </div>
